...
<div class="bg-gradient-to-r from-blue-600 to-indigo-600 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('users.create')); ?>" class="btn-primary bg-white text-blue-600 hover:bg-gray-50">
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($users->currentPage()); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card group">
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-gray-900 group-hover:text-blue-600 transition-colors"><?php echo e($user->name); ?></h3>
                    ...
                    <div class="flex items-center justify-between mb-4 py-3 px-4 bg-gray-50 rounded-lg">
                        <div class="text-center">
                            <p class="text-2xl font-bold text-blue-600"><?php echo e($user->posts->count()); ?></p>
                            <p class="text-xs text-gray-500">Posts</p>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl font-bold text-purple-600"><?php echo e($user->comments->count()); ?></p>
                            <p class="text-xs text-gray-500">Comments</p>
                        </div>
                        <div class="text-center">
                            <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($user->email_verified_at ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'); ?>">
                    ...
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('users.show', $user)); ?>" class="flex-1 bg-blue-50 text-blue-600 px-4 py-2 rounded-lg text-center font-semibold hover:bg-blue-100 transition-colors">
                            View
                        </a>
                        <a href="<?php echo e(route('users.edit', $user)); ?>" class="flex-1 bg-indigo-50 text-indigo-600 px-4 py-2 rounded-lg text-center font-semibold hover:bg-indigo-100 transition-colors">
                            Edit
                        </a>
                        <form action="<?php echo e(route('users.destroy', $user)); ?>" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this user?');">
                            <?php echo csrf_field(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full text-center py-16">
                ...
                <a href="<?php echo e(route('users.create')); ?>" class="btn-primary inline-flex">Create User</a>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sadar\OneDrive\Desktop\Redcode\laravel-11-internship\resources\views/users/index.blade.php ENDPATH**/ ?>