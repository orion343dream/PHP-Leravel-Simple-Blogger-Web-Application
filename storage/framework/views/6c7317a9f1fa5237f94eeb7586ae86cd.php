    ...
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-1">Share your project or idea with the community</p>
            </div>
            <a href="<?php echo e(route('posts.index')); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition">
                Cancel
            </a>
        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6 bg-gray-50 p-4 rounded-lg">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="published" value="1" <?php echo e(old('published', true) ? 'checked' : ''); ?> 
                ...
                <div class="flex gap-4">
                    ...
                    <a href="<?php echo e(route('posts.index')); ?>" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 transition">
                        Cancel
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sadar\OneDrive\Desktop\Redcode\laravel-11-internship\resources\views/posts/create.blade.php ENDPATH**/ ?>