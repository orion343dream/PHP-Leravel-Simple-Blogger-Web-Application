    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('register') }}" class="bg-white text-blue-600 px-10 py-4 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-200">
                    Start Learning Now
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="card group">
            <div class="p-8">
                ...
                <a href="{{ route('users.index') }}" class="text-blue-600 font-semibold inline-flex items-center hover:text-blue-700">
                    Browse Profiles
        ...
        <div class="card group">
            <div class="p-8">
                ...
                <a href="{{ route('login') }}" class="text-purple-600 font-semibold inline-flex items-center hover:text-purple-700">
                    Sign In
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                </a>
            </div>
        ...
        <div class="card group">
            <div class="p-8">
                ...
                <a href="{{ route('posts.index') }}" class="text-green-600 font-semibold inline-flex items-center hover:text-green-700">
                    Browse Posts
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                </a>
            </div>
        ...
        <div class="card group">
            <div class="p-8">
                ...
                <a href="{{ route('users.index') }}" class="text-orange-600 font-semibold inline-flex items-center hover:text-orange-700">
                    View Community
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                </a>
            </div>
...
<div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 py-20">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="{{ route('users.index') }}" class="bg-blue-500 bg-opacity-30 backdrop-blur-sm text-white px-10 py-4 rounded-xl font-bold text-lg border-2 border-white border-opacity-30 hover:bg-opacity-50 transition-all duration-200">
                Explore Community
            </a>
        </div>
    </div>
